    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('seller', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='events.seller')),
            ],
        ),
        migrations.AddField(
            model_name='event',
            name='seller',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='events', to='events.seller'),
        ),
        migrations.CreateModel(
            name='Ticket',
            fields=[
